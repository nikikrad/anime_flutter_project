...
class Autogenerated {
  ...
  Autogenerated({this.data, this.meta, this.links});
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    type = json['type'];
    links = json['links'] != null ? new Links_s.fromJson(json['links']) : null;
...
class PosterImage {
  ...
  PosterImage.fromJson(Map<String, dynamic> json) {
    ...
    meta = json['meta'] != null ? new Meta_s.fromJson(json['meta']) : null;
  }
...
class Meta {
  ...
  Meta.fromJson(Map<String, dynamic> json) {
    dimensions = json['dimensions'] != null
        ? new Dimensions_s.fromJson(json['dimensions'])
        : null;
  }
...
class Dimensions_s {
  ...
  Dimensions_s({this.tiny, this.large, this.small});

  Dimensions_s.fromJson(Map<String, dynamic> json) {
    tiny = json['tiny'] != null ? new Tiny.fromJson(json['tiny']) : null;
    large = json['large'] != null ? new Tiny.fromJson(json['large']) : null;
    small = json['small'] != null ? new Tiny.fromJson(json['small']) : null;
  }
...
class Links_t {
  ...
  Links_t({this.self, this.related});

  Links_t.fromJson(Map<String, dynamic> json) {
    self = json['self'];
...
class Meta_s {
  ...
  Meta_s.fromJson(Map<String, dynamic> json) {
    count = json['count'];
  }
...
class Links_s {
  ...
  Links_s({this.first, this.next, this.last});

  Links_s.fromJson(Map<String, dynamic> json) {
    first = json['first'];
    next = json['next'];
    last = json['last'];
  }
...
class AnimeService {
  Future<List<Data>?> getAnime() async {
    ...
    if (response.statusCode == 200) {
      ...
      var animeData = Autogenerated.fromJson(data);
  ...
  Future<List<Data>?> getAnimeByName(String name) async{
    final response = await http
        .get(Uri.parse("https://kitsu.io/api/edge/anime?filter[text]=$name"));
